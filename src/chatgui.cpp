...
{
    wxString imgFile = "../images/sf_bridge.jpg";
    wxImage image;
...
ChatBotPanelDialog::ChatBotPanelDialog(wxWindow *parent, wxWindowID id)
    ...
    , _chatLogic(new ChatLogic("../src/answergraph.txt", this))
{
...
void ChatBotPanelDialog::AddDialogItem(wxString text, bool isFromUser)
{
    ...
    int sy = dy * GetScrollLines(wxVERTICAL);
    DoScroll(0, sy);
}
...
{
    wxBitmap bitmap = isFromUser ? wxBitmap("../images/user.png", wxBITMAP_TYPE_PNG)
                                 : *static_cast<ChatBotPanelDialog*>(parent)->GetChatLogicHandle()->GetImageFromChatbot();

    _chatBotImg = new wxStaticBitmap(this, wxID_ANY, bitmap, wxPoint(-1, -1), wxSize(-1, -1));
    ...
    SetBackgroundColour((isFromUser == true ? wxT("YELLOW") : wxT("BLUE")));
}
